        ...
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              ...
              <p>
                This hackathon invites students from universities, coding academies, and technical schools across Rwanda to come together and build innovative solutions that address real challenges: preserving survivor testimonies through AI, combating online hate speech, visualizing historical data, and creating platforms that educate and inform.
              </p>
              <p>
